...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(shutdown_history))
        ...
        Me.lbl_screen.TabIndex = 13
        Me.lbl_screen.Text = "Shutdown Log"
        ...
        Me.Name = "shutdown_history"
        Me.Text = "shutdown_history"
...
#Region " Fill Grid "
    Private Sub Fill_Grid()
        ...
        If dte_from.DateBox_Properties.Text <> "" Then
            ...
            p_where &= "shutdown_time >= '" & dte_from.DateBox_Properties.Text & " 00:00:00' "
        End If

        If dte_to.DateBox_Properties.Text <> "" Then
            p_where = Check_where(p_where)
            p_where &= "shutdown_time <= '" & dte_to.DateBox_Properties.Text & " 23:59:59' "
        End If

        ' Get Combined SQL
        p_sql = "Select T1.Date, Case When E1.employee_id Is Not Null Then E1.last_name + ', ' + E1.first_name + (Case When IsNull(E1.middle_initial, '') = '' Then '' Else ', ' + E1.middle_initial + ' ' End) " & _
...
#Region " Get Overall Count "
    Private Sub get_overall()
        ...
        ' ----------------------------
        ' * Get Overall Shutdown Count
        ' ----------------------------
        p_sql = "Select COUNT(*) From shutdown_history"
