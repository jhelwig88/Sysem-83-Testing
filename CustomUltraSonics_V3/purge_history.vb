...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(purge_history))
        ...
        Me.pnl_main.Size = New System.Drawing.Size(643, 550)
        ...
        Me.lbl_screen.TabIndex = 38
        Me.lbl_screen.Text = "Purge Log"
        ...
        Me.dd_bay.Location = New System.Drawing.Point(464, 11)
        ...
        Me.lbl_filter.Location = New System.Drawing.Point(16, 14)
        ...
        Me.Name = "purge_history"
        Me.Text = "purge_history"
...
#Region " Fill Grid "
    Private Sub Fill_Grid()
        ...
        ' ------------------------
        ' * Get Purge History Data
        ' ------------------------
        p_sql = "SELECT purge_started As [Date], bay_number As [Bay #], "

        If g_england_flag Then
            p_sql &= "new_disinfect_lot As [Lot #], "
        End If

        p_sql &= "Case When U1.employee_id Is Null Then U2.employee_id Else U1.employee_id End As employee_id " & _
                 "FROM purge_history a " & _
                 "LEFT JOIN Users U1 On U1.user_id = a.user_id " & _
                 "LEFT JOIN Users_Deleted U2 On U2.user_id = a.user_id "

        ' --------------------------
        ' * Filter By Bay # Selected
        ' --------------------------
        If Trim(dd_bay.ComboBox_Properties.Text) <> "" Then
            p_where = Check_where(p_where)
            p_where &= "bay_number = '" & dd_bay.ComboBox_Properties.Text & "' "
        End If
        ...
        If dte_from.DateBox_Properties.Text <> "" Then
            p_where = Check_where(p_where)
            p_where &= "purge_started >= '" & dte_from.DateBox_Properties.Text & " 00:00:00' "
        End If

        If dte_to.DateBox_Properties.Text <> "" Then
            p_where = Check_where(p_where)
            p_where &= "purge_started <= '" & dte_to.DateBox_Properties.Text & " 23:59:59' "
        End If

        ' Get Combined SQL
        p_sql2 = "Select T1.Date, T1.[Bay #], "

        If g_england_flag Then
            p_sql2 &= "T1.[Lot #], "
        End If

        p_sql2 &= "Case When E1.employee_id Is Not Null Then E1.last_name + ', ' + E1.first_name + (Case When IsNull(E1.middle_initial, '') = '' Then '' Else ', ' + E1.middle_initial + ' ' End) " & _
...
#Region " Get Overall Count "
    Private Sub get_overall()
        ...
        ' -------------------------
        ' * Get Overall Purge Count
        ' -------------------------
        p_sql = "Select COUNT(*) From purge_history"
